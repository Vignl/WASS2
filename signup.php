                ...
                <h4 style="padding-bottom: 20px;text-align: center;color: #28a745;">Register</h4>
                    ...
                    <form method="post" name="signup" onsubmit="return checkpass();">
                        ...
                        <div style="padding-top: 10px;">
                           ...
                           <input type="text" class="form-control" placeholder="Mobile Number" required="" name="mobilenumber" pattern="[0-9]+" maxlength="11"></div>
                           <div style="padding-top: 10px;">
                         ...
                         <div style="padding-top: 10px;">
                           ...
                           <input type="password" class="form-control" name="password" placeholder="Password" minlength="8"required="true">
                       </div>
                       <div style="padding-top: 10px;">
